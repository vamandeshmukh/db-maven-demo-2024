package com.db.demo.despat;

// DesignPatterns 
//
// Creational Patterns
// Focus on the process of object creation.
// Aim to abstract the instantiation process, 
...
// Behavioral Patterns
//
// Focus on communication between objects and the responsibilities of objects.
// Deal with the interaction and responsibilities of objects.
//
// Command Pattern: Encapsulates a request as an object, thereby allowing for parameterization of clients with queues, requests, and operations.
// Template Pattern: Defines the skeleton of an algorithm in the base class but lets subclasses override specific steps without changing the algorithm's structure.
